...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaE.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				if(txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
					double valor = reservasController.valorReserva(txtFechaE.getDate(), txtFechaS.getDate(), precio);
		...
		// Propiedad para obtener la fecha seleccionada
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {	
					if(txtValor.getText().equals("0.0") || txtValor.getText().equals("")) {
