...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    String textoDescripcion = "<html><body>El Sistema de Reservas, es una aplicación para llevar el control de la gestión  <br> de reservas y de huespédes en el  hotel   </body></html>";
	    ...
	    String textoDescripcion1 = "<html><body> Opciones del Sistema:</body></html>";
	    ...
	    JLabel lblNewLabel_3_1 = new JLabel("- Reportes de Reservas y Huéspedes existentes");
	    lblNewLabel_3_1.setFont(new Font("Roboto", Font.PLAIN, 17));
	    lblNewLabel_3_1.setBounds(312, 482, 355, 27);
	    contentPane.add(lblNewLabel_3_1);
	    
	    JLabel lblNewLabel_3_2 = new JLabel("- Eliminar registros");
